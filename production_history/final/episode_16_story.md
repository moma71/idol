...
- [ ] "PRISM 데뷔 준비" 프로젝트 열기
- [ ] 위 프롬프트 복사 후 붙여넣기
- [ ] {팀명}, {점수}, {기간}을 실제 상황으로 수정
- [ ] 우려 사항에 자신의 구체적 불안 요소 추가 (예: "무릎 부상 이력")
- [ ] Enter로 실행
- [ ] 결과를 팀 공유 문서에 복사
- [ ] 매일 아침 컨디션 체크리스트 작성 (5분)
- [ ] 주간 회고 시 점수 변동 확인 (유지 vs 하락)
- [ ] 17일 후 평가 당일까지 80점 유지 여부 검증
...
Detailed illustration prompts and analysis in: `episode_16_illustrations.md`

---

**Episode 16 완료**
- Word count: ~4,900자 (스토리 본문)
- Tutorial: Pattern B (문제 분석형, 30-40%)
- Timeline: 1/12-16
- Key moment: 80점 달성 + 유지 모드 전환
- Next: Episode 17 (최종 준비)
